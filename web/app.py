...
with col_m4:
    dadata_status = "ПОДКЛЮЧЕНО" if dadata_client.is_configured else "ТЕСТОВЫЙ РЕЖИМ"
    dadata_hint = "200 OK" if dadata_client.is_configured else "Добавьте DADATA_API_KEY"
    st.metric("Интеграция DaData API", dadata_status, delta=dadata_hint, delta_color="off")
